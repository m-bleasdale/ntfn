...
export const MDXComponents = {
	h1: (props) => <h1 className="text-4xl font-semibold my-10" {...props}/>,
	h2: (props) => <h2 className="text-3xl font-semibold my-10" {...props}/>,
	h3: (props) => <h2 className="text-2xl font-semibold my-10" {...props}/>,
